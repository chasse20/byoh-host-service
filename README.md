...
This repository is a sanitized code sample from a platform built in 2019-2022. It is included to demonstrate architecture, systems integration, cloud orchestration, and ownership of a complex production platform. It is not intended to represent my current preferred stack or coding conventions.
