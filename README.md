...
This repository is a sanitized code sample from a platform built in 2019-2023 for Van MetreHomes. It is included to demonstrate architecture, systems integration, cloud orchestration, and ownership of a complex production platform.
